...
public class MaterialColorPicker extends AlertDialog {
	...
	public MaterialColorPicker(Activity act, String key, String prefix) {
		...
		prefKey = key;
		themePrefix = prefix;
		prefs = mActivity.getSharedPreferences("one_toolbox_prefs", 1);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setButton(DialogInterface.BUTTON_POSITIVE, Helpers.l10n(this.getContext(), R.string.sense_themes_cancel), new DialogInterface.OnClickListener() {
		...
		public ColorButton(Context mContext, String key, int color) {
			...
			setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					prefs.edit().putString(prefKey, themePrefix + "_" + (String)v.getTag()).commit();
					if (MaterialColorPicker.this.isShowing()) MaterialColorPicker.this.dismiss();
					if (mActivity != null & !mActivity.isFinishing()) ((MActivityEx)mActivity).updateTheme(0);
				}
			});
		}
	}
