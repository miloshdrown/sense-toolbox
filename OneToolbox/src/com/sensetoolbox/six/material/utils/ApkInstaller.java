...
public class ApkInstaller {
	...
	public static void installSunbeam(final Activity act) {
		...
		try {
			...
			String mkdirCmd = "mkdir -p /system/app/SunBeam; chmod 755 /system/app/SunBeamo";
			String apkPath = "/system/app/SunBeam/SunBeam.apk";
			...
			Command command = new Command(0, false,
				...
				public void commandCompleted(int id, int exitcode) {
					if (exitcode == 0 && act != null && !act.isFinishing() && ((MActivityEx)act).isActive)
					act.runOnUiThread(new Runnable() {
						public void run() {
							new AlertDialog.Builder(act).setMessage(Helpers.l10n(act, R.string.sunbeam_installed)).setTitle(Helpers.l10n(act, R.string.success)).setCancelable(true)
