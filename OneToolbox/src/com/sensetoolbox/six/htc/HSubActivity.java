...
public class HSubActivity extends HActivityEx {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getFragmentManager().beginTransaction().replace(R.id.fragment_container, new HSubFragment(pref_section_xml)).commit();
	}
